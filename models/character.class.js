class Character extends MovableObject {
  ...
  longIdleImages = [
    ...
    stopIdleAnimation() {
        console.log("stopIdleAnimation was called");
    ...
    toggleMute() {
        ...
        this.walking_sound.muted = this.muted;
        this.jump_sound.muted = this.muted;
        this.coin_sound.muted = this.muted;
        this.hurt_sound.muted = this.muted;
    }
